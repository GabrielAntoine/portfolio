...
// When localized is true, the label must be retrieved from the next-intl json using the key "data.tags.[tag name]"
type TagValue = { icon: ReactNode; url?: string } & (
...
const _tags = {
  ...
  oracle: {
    ...
    label: 'Oracle',
    icon: <GrOracle />,
    url: 'https://www.oracle.com/europe/database/technologies/',
  },
  tanstackquery: {
    localized: false,
    label: 'Tanstack Query',
    icon: (
      // This is the Simple Icon icon for Tanstack which isn't in react-icons yet
  ...
  c: {
    ...
    label: 'C',
    icon: <SiC />,
    url: 'https://fr.cppreference.com/c',
  },
  cpp: {
    localized: false,
    label: 'C++',
    icon: <SiCplusplus />,
    url: 'https://cppreference.com/Main_Page',
  },
  js: {
    localized: false,
    label: 'JavaScript',
  ...
  neon: {
    ...
    label: 'Neon',
    icon: (
      // The official icon from https://neon.com/brand
      <svg
        width='64'
        height='64'
        viewBox='0 0 64 64'
...
export type Tag = keyof typeof _tags

export const tags: Record<Tag, TagValue> = _tags
